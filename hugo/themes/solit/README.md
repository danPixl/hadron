...
[params]
  ...
  # Fonts settings.
  googlefonts = "https://fonts.googleapis.com/css?family=Bungee|Lato:400,700" # Optional, Include google fonts.
  fontfamily = "Lato,YuGothic,'Hiragino Kaku Gothic Pro',Meiryo,sans-serif" # Optional, Override body font family.
  logofontfamily = "Beungee, cursive" # Optional, Override logo font.
```
